...
public class ViewState {
    ...
    /**
     * Setter for the displayed message in the state.
     * @param displayedMessage Message object to set in the state.
     */
    ...
    /**
     * Getter for the displayed message in the state-
     * @return Message object to get from the state.
     */
